...
COPY --from=build --chmod=755 /usr/local/share/lua/5.4/resty /usr/local/share/lua/5.1/resty
COPY --from=build --chmod=755 /usr/local/share/lua/5.4/ffi-zlib.lua /usr/local/share/lua/5.1/ffi-zlib.lua
